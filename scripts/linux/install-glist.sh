...
$PKG_INSTALL git cmake clang libc++ libc++abi-dev libglew-dev curl libcurl4-openssl-dev libssl-dev build-essential openssl libomp-dev llvm libglfw3-dev libglm-dev libfreetype6-dev libassimp-dev wget pkg-config unzip
